...
<table class="table table-hover">
  ...
  @foreach($categories as $category)
    <tr>
        <th scope="row">
            <img src="{{asset('images/categories/'.$category->cat_img)}} " alt="{{$category->cat_name}}" class="admin-thumbnail">
        </th>
      <td class="align-middle">{{$category->cat_name}}</td>
      <td class="align-middle">{{$category->cat_slug}}</td>
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
          ...
          <a href=""><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-trash" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
